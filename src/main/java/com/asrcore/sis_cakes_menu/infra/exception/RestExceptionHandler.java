...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<ErrorResponse> accessDeniedHandler(AccessDeniedException exception) {
        ErrorResponse error = new ErrorResponse(HttpStatus.FORBIDDEN.value(), "Forbidden", exception.getMessage());
